...
public class JavaDev {
    ...
    public static void debugProject(String pathString) throws IOException, InterruptedException{
        ...
        try (Scanner myReader = new Scanner(myObj)) {
            ...
            exec(new String[]{"javac","-d",pathString+"/"+"bin",pathString+"/"+path1+fileName+".java"});
        }
    ...
    public static void createFileConfJson(String path,String pkg,String vsn,String mclss,String prtp) throws IOException{
